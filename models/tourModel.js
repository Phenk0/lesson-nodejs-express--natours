...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      validate: [
        ...
        'Tour name only allows alphabets, spaces, hyphens or apostrophes characters. Tour name must start and end only with alphabets'
      ]
    },
    slug: String,
    ...
    priceDiscount: {
      type: Number,
      validate: [
        //only points to a new document creation
        function (value) {
